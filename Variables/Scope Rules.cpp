...
//
//void static_local_example() {
//	static int num{ 5000 }; // local to static_local_example - retains it value between calls
//	cout << "\nLocal static num is: " << num << " in static_local_example - start" << endl;
//	num += 1000;
//	cout << "Local static num is: " << num << " im static_ local_example - end" << endl;
//}
//
//
//int main() {
...
//		cout << "Inned block in main can see out - num1 is: " << num1 << endl;
//	}
//
//	cout << "Local num is: " << num << " in main" << endl;
//
